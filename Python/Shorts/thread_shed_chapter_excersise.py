...
for transaction in daily_transactions_split:
    ...
    for item in transaction:
        deeper_trans_clean.append(item.strip())
    transactions_clean.append(deeper_trans_clean)
...
# little loop to get all colors separated
thread_sold_split = []
...
#Litle loop to get unique colors list "colors"
...
for color in colors:
    print("The thread shed sold {} {} threads".format(color_count(color),color))
